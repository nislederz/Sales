[assembly: Xamarin.Forms.ExportRenderer(typeof(Sales.Views.LoginInstagramPage), typeof(Sales.Droid.Implementations.LoginInstagramPageRenderer))]
...
namespace Sales.Droid.Implementations
{
    ...
    public class LoginInstagramPageRenderer : PageRenderer
    {
        protected override void OnElementChanged(ElementChangedEventArgs<Page> e)
        {
            ...
            //var auth = new OAuth2Authenticator(clientId: InstagramAppID, scope: InstagramScope, authorizeUrl: new Uri(InstagramAuthURL),
