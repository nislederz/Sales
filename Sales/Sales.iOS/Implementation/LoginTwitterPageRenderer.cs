[assembly: Xamarin.Forms.ExportRenderer(typeof(Sales.Views.LoginTwitterPage), typeof(Sales.iOS.Implementations.LoginTwitterPageRenderer))]
...
namespace Sales.iOS.Implementations
{
    ...
    {
        bool done = false; public override void ViewDidAppear(bool animated)
        {
            //base.ViewDidAppear(animated); if (done) { return; }
            ...
            //var auth = new OAuth1Authenticator(consumerKey: twitterConsumerKey,
            //consumerSecret: twitterConsumerSecret,  requestTokenUrl: new Uri(twitterRequestTokenURL),  authorizeUrl: new Uri(twitterAuthorizeURL),  callbackUrl: new Uri(url),  accessTokenUrl: new Uri(twitterAccessTokenURL));
            ...
            //    }
            //};
            //done = true; PresentViewController(auth.GetUI(), true, null);
        }
