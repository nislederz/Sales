[assembly: Xamarin.Forms.ExportRenderer(typeof(Sales.Views.LoginInstagramPage), typeof(Sales.iOS.Implementations.LoginInstagramPageRenderer))]
...
namespace Sales.iOS.Implementations
{
    ...
    public class LoginInstagramPageRenderer : PageRenderer
    {
        ...
        public override void ViewDidAppear(bool animated)
        {
            ...
            //var auth = new OAuth2Authenticator(clientId: instagramAppID, scope: instagramScope, authorizeUrl: 
            //    new Uri(instagramAuthURL), redirectUrl: new Uri(instagramRedirectURL));
        ...
        public async Task<InstagramResponse> GetInstagramProfileAsync(string accessToken)
        {
            ...
            var requestUrl = string.Format("{0}={1}", InstagramProfileInfoURL, accessToken);
            var apiService = new ApiService(); return await apiService.GetInstagram(requestUrl);
        }
    }
}